...
export const faqs: FAQ[] = [
  ...
  { id: "9", question: "Hvilke sertifiseringer har ABC Sikkerhet?", answer: "ABC Sikkerhet AS er sertifisert etter ISO 9001:2015 (kvalitetsledelse), ISO 45001:2018 (HMS-ledelse) og IRATA (Industrial Rope Access). Vi er også medlem av SOFT (Skandinavisk organisasjon for fallsikring).", category: "Generelt", tags: ["ISO", "IRATA", "SOFT", "sertifisering"] },
  ...
  { id: "11", question: "Hva koster et kurs i fallsikring?", answer: "Pris på kurs varierer etter type kurs, antall deltakere og om det gjennomføres hos oss eller på din arbeidsplass. Kontakt oss på finn@abcfallsikring.no eller +47 33 74 08 88 for et tilbud tilpasset din bedrift.", category: "Kurs og opplæring", tags: ["kurs", "pris", "opplæring"] },
